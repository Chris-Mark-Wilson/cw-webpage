...
return (
  <div  >
    Ai generated by <a href="https://openai.com/" style={{color:"blue"}}>open ai</a>
    <br/>
    Model is from the GPT 3.5 family, "text-davinci-003(legacy)"
    <br/>
    You will need an api key, log in, sign up for a free account, you get £5 for free and each "prompt" costs around £0.0024p
    <br/><br/>
